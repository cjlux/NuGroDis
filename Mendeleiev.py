...
class PyChemicalElement:
    ...
    def __init__(self, symbol, atomicNumber, density,  molarMass, YoungModulus, PoissonCoeff):
...
if __name__ == "__main__":
    ...
    print(PyChemicalComposition("NaCl"))
    print(PyChemicalComposition("H2O"))
